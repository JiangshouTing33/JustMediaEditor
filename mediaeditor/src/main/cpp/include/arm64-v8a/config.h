...
#define FFMPEG_CONFIGURATION "--logfile=conflog.txt --target-os=android --prefix=/Users/st_jiang/workspace/MediaLearn/build/ffmpeg/android/arm64-v8a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=aarch64 --cc=/Users/st_jiang/Library/Android/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-gcc --cross-prefix=/Users/st_jiang/Library/Android/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android- --nm=/Users/st_jiang/Library/Android/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-nm --extra-cflags=-I/Users/st_jiang/workspace/MediaLearn/build/x264/android/arm64/include --extra-cflags=-I/Users/st_jiang/workspace/MediaLearn/build/fdkaac/android/arm64/include/ --extra-ldflags=-L/Users/st_jiang/workspace/MediaLearn/build/fdkaac/android/arm64/lib --extra-ldflags=-L/Users/st_jiang/workspace/MediaLearn/build/x264/android/arm64/lib --sysroot=/Users/st_jiang/Library/Android/android-ndk-r14b/platforms/android-21/arch-arm64/ --extra-cflags= --extra-ldflags='-lx264 -Wl,-rpath-link=/Users/st_jiang/Library/Android/android-ndk-r14b/platforms/android-21/arch-arm64//usr/lib -L/Users/st_jiang/Library/Android/android-ndk-r14b/platforms/android-21/arch-arm64//usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=image2 --enable-demuxer=gif --enable-demuxer=wav --enable-demuxer=aac --disable-decoders --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=pcm_s16le --enable-decoder=hevc --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mp3 --enable-muxer=ipod --enable-muxer=gif --enable-muxer=adts --enable-muxer=pcm_alaw --enable-muxer=pcm_f32be --enable-muxer=pcm_f32le --enable-muxer=pcm_f64be --enable-muxer=pcm_f64le --enable-muxer=pcm_mulaw --enable-muxer=pcm_s16be --enable-muxer=pcm_s24be --enable-muxer=pcm_s24le --enable-muxer=pcm_s32be --enable-muxer=pcm_s32le --enable-muxer=pcm_s8 --enable-muxer=pcm_u16be --enable-muxer=pcm_u16le --enable-muxer=pcm_u24be --enable-muxer=pcm_u24le --enable-muxer=pcm_u32be --enable-muxer=pcm_u32le --enable-muxer=pcm_u8 --enable-muxer=pcm_vidc --enable-encoders --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=atempo --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --enable-gpl --enable-nonfree --enable-zlib --enable-libx264 --enable-libfdk-aac --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=vp9_mediacodec --enable-decoder=vp8_mediacodec --enable-decoder=hevc_mediacodec --enable-hwaccels --enable-asm --enable-version3"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/Users/st_jiang/workspace/MediaLearn/build/ffmpeg/android/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/st_jiang/workspace/MediaLearn/build/ffmpeg/android/arm64-v8a/share/ffmpeg"
